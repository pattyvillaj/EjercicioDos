...
import co.com.choucair.certification.RetoLatam.userinterface.LatamConfirmation;
...
public class Answer implements Question<Boolean> {
    ...
    public Boolean answeredBy(Actor actor) {
        ...
        String textConfirmed = Text.of(LatamConfirmation.CONFIRMATION_CODE).viewedBy(actor).asString();
